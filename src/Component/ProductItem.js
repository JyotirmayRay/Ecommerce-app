...
export default function ProductItem({ item }) {
  ...
  function handleDelelteProduct(item) {
    let url = `https://my-json-server.typicode.com/JyotirmayRay/dummy-product/db${item.id}`;
      ...
      <div className="align-self-end d-flex align-items-center gap-4 flex-lg-grow-1 p-1">
        ...
        {item.edit ? (
          <>
            ...
            <span>
              <img
                src="https://img.icons8.com/external-inkubators-detailed-outline-inkubators/25/FA5252/external-delete-ecommerce-user-interface-inkubators-detailed-outline-inkubators-2.png"
                alt="error"
                width={"30rem"}
                style={{ cursor: "pointer" }}
